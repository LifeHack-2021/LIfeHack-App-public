...
export default function DonorProfile(props) {
    ...
    let [currentDisplay, setCurrentDisplay] = useState("Donations")
    ...
    let refresh = () => {
        axios.post(`${SERVER_URL}/items/getDonorItems`,
            {
    ...
    return (
        <>
            ...
            >
                <Center my='auto'>
                    ...
                    <Text fontSize={15} color="white" marginTop={3}>
                        {/* {console.log(userInfo.role)} */}
                        {userInfo.role = ((userInfo.role == 'donor') ? 'Recipient' : 'Donor')}
                    </Text>
            ...
            <Stack space={3} alignItems="center">
                <HStack space={3} alignItems="center">
                    <Button
                        ...
                        variant="outline"
                        onPress={() => { setCurrentDisplay("Donations") }}
                        endIcon={
            ...
            {/* Views */}
            {
                ...
                >
                    {(currentDisplay == "Donations") ? <DonationView userInfo={userInfo} allData={data} activeList={activeList} reviewList={reviewList} /> : <FriendsView userInfo={props.userInfo} setFriendsNo={setFriendsNo} friends={friends} />}
                </ScrollView>
            }
        </>
    )
