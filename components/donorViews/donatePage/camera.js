...
import { Text, Button, NativeBaseProvider, Modal, Box, Image, useToast } from 'native-base';
        ...
        axios.post('http://lifehackproductdetection-env.eba-fkpmm9bs.us-east-1.elasticbeanstalk.com/api/upload', {
            ...
            .then(res => {
                ...
                if (processed != [] && processed != '') {
                    console.log('processed not empty', processed)
                    ...
                    for (let i = 0; i < rawData.length; i++) {
                        let o = {
                            name: rawData[i].Name,
                            items: [{ name: rawData[i].Name, confidence: rawData[i].Confidence }]
                        }
                        finArr.push(o)
                    }
                    console.log(finArr)
                    props.setRecoItemList(finArr)
                    props.setTakePic(false)
                }
